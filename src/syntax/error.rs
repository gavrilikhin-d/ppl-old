...
#[diagnostic(code(parser::missing_expression))]
...
#[diagnostic(code(parser::missing_declaration))]
...
#[diagnostic(code(parser::missing_statement))]
...
#[diagnostic(code(parser::missing_variable_name))]
